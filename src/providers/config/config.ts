...
export class ConfigProvider {
  ...
  public url: string = 'https://emalldoha.com/beta/';
  public consumerKey: string = 'ck_54d7782de2855a8d97682c2f1549b8a423936775';
  public consumerSecret: string = 'cs_76671bb3ad809631a374d8e8ab9882e0cf40a942';
  ...
  public onePageCheckOut = false; // <!-- 2.0 updates -->
  ...
  public siteSetting() {
    return new Promise(resolve => {
      this.http.get(this.url + '/api/appsettings/get_all_settings/?insecure=cool').map(res => res.json()).subscribe(data => {
        ...
        else this.onePageCheckOut = false;// <!-- 2.0 updates -->
